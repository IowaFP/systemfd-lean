...
| letopentype_congr : Red Γ (b::tl) (b'::tl) -> Red Γ ((.letopentype A b)::tl) ((.letopentype A b')::tl)
| letopen_congr : Red Γ (b::tl) (b'::tl) -> Red Γ ((.letopen A b)::tl) ((.letopen A b')::tl)
| letdata_congr : Red Γ (b::tl) (b'::tl) -> Red Γ ((.letdata A n b)::tl) ((.letdata A n b')::tl)
| letctor_congr : Red Γ (b::tl) (b'::tl) -> Red Γ ((.letctor A b)::tl) ((.letctor A b')::tl)
| insttype_congr : Red Γ (b::tl) (b'::tl) -> Red Γ ((.insttype A b)::tl) ((.insttype A b')::tl)
| inst_congr : Red Γ (b::tl) (b'::tl) -> Red Γ ((.inst x A b)::tl) ((.inst x A b')::tl)
