...
instance : Coe (Subst.Action Surface.Term) Surface.Term where
...
instance : RenMap Surface.Term where
...
instance : SubstMap Surface.Term Surface.Ty where
...
instance : SubstMap Surface.Term Surface.Term where
...
instance : SubstMapId Surface.Term Surface.Ty where
...
instance : SubstMapStable Surface.Term where
...
instance : SubstMapRenCommute Surface.Term Surface.Ty where
...
instance : SubstMapCompose Surface.Term Surface.Ty where
...
instance : SubstMapCompose Surface.Term Surface.Term where
